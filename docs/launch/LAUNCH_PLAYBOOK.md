# COMPANION v1.4.0 Launch Playbook
...
- Submit v1.4.0 with **deferred publishing** enabled.
...
- Create the `v1.4.0` GitHub release from `RELEASE_NOTES_1.4.0.md`.
...
- Publish the GitHub `v1.4.0` release.
