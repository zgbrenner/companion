# COMPANION v1.4.1 Launch Playbook
...
- Submit v1.4.1 with **deferred publishing** enabled.
...
- Create the `v1.4.1` GitHub release from `RELEASE_NOTES_1.4.1.md`.
...
- Publish the GitHub `v1.4.1` release.
