...
Security fixes are applied to the latest published COMPANION release. During the v1.2.0 release-candidate period, reports should reference the exact commit or package checksum tested.
