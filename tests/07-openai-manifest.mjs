...
assert(manifest.version === "1.3.0", `expected version 1.3.0, got ${manifest.version}`);
...
assert(/worker-src 'self' blob:/.test(manifest.content_security_policy?.extension_pages || ""), "local ONNX worker policy is explicit");
